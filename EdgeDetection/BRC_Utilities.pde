...
int BRC_port = 10002;
int BRC_WebBodySize = 8071;

String[] BRC_ids = new String[] {"file","Camera","load","threshold","grayscale","vertical","horizontal","omni"};
String[] BRC_values = new String[] {"H","false","0","200","0","0","0","0"};
...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"NOTE\",\"brc_1\",\"note\"],\n"
+ "[\"DROPDOWN\",\"brc_2\",\"file\"],\n"
+ "[\"CHECKBOX\",\"brc_3\",\"Camera\"],\n"
+ "[\"BUTTON\",\"brc_4\",\"load\"],\n"
+ "[\"RANGE\",\"brc_5\",\"threshold\",\"brc_6\"],\n"
+ "[\"BUTTON\",\"brc_7\",\"grayscale\"],\n"
+ "[\"BUTTON\",\"brc_8\",\"vertical\"],\n"
+ "[\"BUTTON\",\"brc_9\",\"horizontal\"],\n"
+ "[\"BUTTON\",\"brc_10\",\"omni\"]];\n"
+ "\n"
+ "Monitor = false;\n"
+ "\n"
...
+ "\n"
+ "<table><tr><td><table><tr><td class=\"auto-style1\"><label id=\"brc_1\">Edge detection</label></td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">Files:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_2\" id=\"brc_2\" onchange=\"SendNameValue('file='+document.brc.brc_2.value);\">\n"
+ "<option selected=\"selected\" value=\"H\">House</option>\n"
+ "<option  value=\"C\">Car</option>\n"
+ "<option  value=\"B\">Butterfly</option>\n"
+ "</select></td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">\n"
+ "Use Camera:  <input name=\"brc_3\" type=\"checkbox\"  id=\"brc_3\" onclick=\"SendCheckbox('brc_3','Camera');\"/> \n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Load\" onClick=\"SendNameValue('load='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><table ><tr><td class=\"auto-style1\">0  \n"
+ "    <input type=\"range\" id=\"brc_5\" name=\"brc_5\" min=\"0\" max=\"400\" value=\"200\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_5','brc_6','threshold');\" />  400<br/>\n"
+ "    threshold: <label id=\"brc_6\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "</td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Grayscale\" onClick=\"SendNameValue('grayscale='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Vertical edges\" onClick=\"SendNameValue('vertical='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Horizontal edges\" onClick=\"SendNameValue('horizontal='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Omni-directional\" onClick=\"SendNameValue('omni='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td></tr></table>\n"
+ "\n"
